...
export default function AddressSelector({ addLocation }: DataType) {
              ...
              <div className="text-center">
                ...
                <div className="flex flex-col space-y-3">
                  ...
                  <button
                    ...
                    className="w-full px-4 py-2 border border-purple-600 text-purple-600 rounded-md hover:bg-purple-50 transition-colors duration-300"
                  >
                    Update Manually
                  </button>
                </div>
          ...
          >
            <div className="bg-white rounded-lg shadow-xl w-full max-w-3xl h-[500px] overflow-hidden relative">
              <button
                ...
                className="absolute top-4 right-4 bg-purple-600 text-white rounded-full p-2"
              >
