...
import { fetchSavedLocations } from "../utils/apis";
import { useRouter } from "next/navigation";
import AddressSelector from "../shop/AddressSelector";
...
export default function Component() {
  ...
  return (
    <div className="min-h-screen bg-gray-900">
          ...
          <div className="bg-purple-600 px-4 py-4 sm:px-6">
            <div className="flex items-center justify-between">
              <button
                ...
                className="rounded-full p-2 text-white hover:bg-purple-500 transition-colors"
                aria-label="Go back"
              >
              ...
              <button
                ...
                className="flex items-center gap-2 rounded-lg bg-white px-3 py-1.5 text-sm font-medium text-purple-600 hover:bg-purple-50 transition-colors"
              >
          ...
          <div className="space-y-6 p-4 sm:p-6">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="h-12 w-full rounded-lg border pl-10 pr-4 text-lg outline-none focus:border-purple-500 focus:ring-4 focus:ring-purple-100"
                value={searchQuery}
                ...
                <div className="space-y-3">
                  {filteredLocations.map((location) => (
                    <button
                      ...
                      className="group flex w-full items-start gap-4 rounded-lg border bg-white p-4 text-left hover:bg-purple-100 transition-colors"
                    >
                      ...
                      <ArrowRight className="h-5 w-5 flex-shrink-0 text-purple-600 opacity-0 transition-opacity group-hover:opacity-100" />
                    </button>
                  ))}
                </div>
              )}
      ...
      {showMap && <AddressSelector addLocation={true} />}
    </div>
  );
}
