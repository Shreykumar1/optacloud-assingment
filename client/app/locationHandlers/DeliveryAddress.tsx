...
import { saveAddress } from "../utils/apis";
          ...
          >
            <div className="flex flex-col items-center">
              ...
              <Label
                ...
                className={`flex flex-col items-center cursor-pointer p-2 rounded-lg ${
                  saveAs === "home" ? "bg-purple-100" : "hover:bg-gray-100"
                }`}
              >
                <Home
                  className={`w-6 h-6 ${
                    saveAs === "home" ? "text-purple-500" : "text-gray-500"
                  }`}
                />
            ...
            <div className="flex flex-col items-center">
              ...
              <Label
                htmlFor="office"
                className={`flex flex-col items-center cursor-pointer p-2 rounded-lg ${
                  saveAs === "office" ? "bg-purple-100" : "hover:bg-gray-100"
                }`}
              >
                <Briefcase
                  className={`w-6 h-6 ${
                    saveAs === "office" ? "text-purple-500" : "text-gray-500"
                  }`}
                />
            ...
            <div className="flex flex-col items-center">
              ...
              <Label
                htmlFor="friends"
                className={`flex flex-col items-center cursor-pointer p-2 rounded-lg ${
                  saveAs === "friends" ? "bg-purple-100" : "hover:bg-gray-100"
                }`}
              >
                <Users
                  className={`w-6 h-6 ${
                    saveAs === "friends" ? "text-purple-500" : "text-gray-500"
                  }`}
                />
            ...
            <div className="flex flex-col items-center">
              ...
              <Label
                htmlFor="family"
                className={`flex flex-col items-center cursor-pointer p-2 rounded-lg ${
                  saveAs === "family" ? "bg-purple-100" : "hover:bg-gray-100"
                }`}
              >
                <Heart
                  className={`w-6 h-6 ${
                    saveAs === "family" ? "text-purple-500" : "text-gray-500"
                  }`}
                />
